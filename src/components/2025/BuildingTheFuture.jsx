  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 text-center">
        <p className="text-3xl md:text-4xl font-bold font-averia mb-6 text-slate-800 dark:text-white">
          About Inheritance Infrastructure Pvt. Ltd.
        </p>
        <p className="text-lg max-w-3xl mx-auto leading-relaxed mb-6 text-slate-700 dark:text-gray-200">
        ...
        <h3 className="flex justify-center items-center gap-2 text-xl font-semibold mb-2 text-slate-800 dark:text-white">
        ...
        <div className="inline-block bg-[#ed8161] text-white px-5 py-2 rounded-md hover:bg-[#c75c45] transition duration-300 cursor-pointer">
          Read More
        </div>
      </div>
    </section>
